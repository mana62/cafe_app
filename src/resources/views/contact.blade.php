      ...
      {{-- <div class="contact-img">
        ...
        <form action="" method="POST" class="contact__form">
            ...
            <div class="contact__item">
                ...
                <input type="email" id="email" name="email" class="contact__form-input" placeholder="例：example@email.com">
            </div>

            <div class="contact__item">
                <label for="content" class="contact__form-label">お問い合わせ内容 <span class="contact__form-required">必須</span></label>
                <textarea id="content" name="content" class="contact__form-textarea" placeholder="お問い合わせ内容を入力してください"></textarea>
            </div>
